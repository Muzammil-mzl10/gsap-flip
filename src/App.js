...
function App() {
   const articles = [
    {
      id: 0,
      url: require("../src/Images/exp-1.jpeg"),
      color: "#e3ebec",
      desc: "Basel-Stadt, Schweiz",
    },
    {
      id: 1,
      url: require("../src/Images/exp-2.jpeg"),
      color: "#fff",
      desc: "Claudio Schwarz",
    },
    {
      id: 2,
      url: require("../src/Images/exp-3.jpeg"),
      color: "#8390a2",
      desc: "Thyssenturm in Rottweil",
    },
    {
      id: 3,
      color: "#d4d4d4",
      url: require("../src/Images/exp-4.jpeg"),
      desc: "Spiral",
    },
    {
      id: 4,
      url: require("../src/Images/exp-5.jpeg"),
      color: "#d0dff3",
      desc: "Patterned building. Hexagon windows.",
    },
  ];
...
<div class="page-logo">
    ...
    <div class="detail">
      ...
      <p>
        ...
        perspiciatis deserunt voluptas modi ut commodi dicta, corporis nisi
        atque nihil ad dolorum officiis unde. Labore ratione aliquam repudiandae
        cum dolorum? Lorem ipsum dolor sit amet consectetur adipisicing elit.
        Debitis, laboriosam. Eius laboriosam maxime quis tempore, inventore
        libero debitis hic sint commodi cupiditate id, assumenda necessitatibus,
        ex dolor voluptates quia facere.
      </p>
      <p>
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cupiditate
        perspiciatis deserunt voluptas modi ut commodi dicta, corporis nisi
